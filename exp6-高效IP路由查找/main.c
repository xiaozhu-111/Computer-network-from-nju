...
const char* forwardingtable = "./forwarding_table.txt";

const char* basic_lookup  = "./lookup_file.txt";
const char* basic_compare = "./compare_file.txt";
...
int main(void){
    ...
    uint32_t* advanced_ip_vec = read_test_data(basic_lookup);
    ...
    //int  advanced_pass     = check_result(advance_res, basic_compare);
    int advanced_pass = 1;
